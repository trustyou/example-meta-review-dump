...
done_files=$(aws s3 ls s3://trustyou-api-us-staging/meta-review/ --recursive | grep done$)
...
aws s3 sync s3://trustyou-api-us-staging/$latest_date/ $dest_folder/$latest_date/ --exclude done
